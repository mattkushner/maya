...
def transfer_weights(source_shape, dest_shape):
    ...
    mc.copySkinWeights(sourceSkin=source_shape, destinationSkin=dest_shape, noMirror=True, surfaceAssociation="closestPoint", influenceAssociation=("label", "oneToOne", "closestJoint"))
